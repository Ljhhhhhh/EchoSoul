...
.report-header {
  @apply sticky top-0 z-10 bg-white border-b border-neutral-200;
}
...
.chapter-navigation {
  @apply w-80 bg-white border-r border-neutral-200 p-6 sticky top-20 h-screen overflow-y-auto;
}
...
.stat-item {
  @apply flex items-center space-x-1 text-neutral-500;
}
...
.chapter-item {
  @apply flex items-center space-x-3 p-3 rounded-lg cursor-pointer transition-colors hover:bg-neutral-100;
}
...
.chapter-number {
  @apply w-5 h-5 bg-neutral-200 rounded-full flex items-center justify-center text-xs;
}
...
.content-area {
  @apply flex-1 max-w-4xl mx-auto p-6;
}
...
.key-metrics {
  @apply grid grid-cols-3 gap-6 mt-6 pt-6 border-t border-neutral-200;
}
...
.chapter-section {
  @apply bg-white p-8 rounded-lg shadow-sm mb-8;
}
...
.content-text {
  @apply text-body-large text-neutral-700 leading-relaxed;
}
...
.subsection {
  @apply pl-6 border-l-2 border-neutral-200;
}

.subsection-content {
  @apply text-body-medium text-neutral-700 leading-relaxed;
}
