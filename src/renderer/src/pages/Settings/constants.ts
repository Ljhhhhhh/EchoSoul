import { ProviderTemplates, PromptTemplate, PromptCategory } from './types'
...
export const PROMPT_CATEGORIES: PromptCategory[] = [
  ...
  { value: 'personality', label: '人格分析', description: '深入了解性格特征和行为模式' },
  { value: 'relationship', label: '关系分析', description: '分析与特定联系人的互动模式' },
  { value: 'work', label: '工作分析', description: '分析工作群聊的氛围和团队动态' },
  { value: 'custom', label: '自定义', description: '其他类型的自定义分析' }
]
